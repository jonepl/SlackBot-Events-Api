...
class SlackWebApi(object) :
    ...
    def writeToSlack(self, channel, text, attachments=[], blocks=[]):
    ...
    def writeToFile(self, channel, filePath, filename=None, title=None) :
    ...
    def getIMHistory(self, channel, count=100, inclusive=True, unreads=True) :
